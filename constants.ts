...
export const POSTS: Post[] = [
  { id: 'p1', userId: 'u1', imageUrl: 'https://picsum.photos/id/103/600/800', caption: 'Wonderful time in the pool, best day ever, thanks! @specialist #pool #summer #party', likes: 54, comments: [{id: 'c1', userId: 'u2', text: 'Looks amazing!'}, {id: 'c2', userId: 'u3', text: 'So jealous!'}], timestamp: '5 mins ago' },
  { id: 'p2', userId: 'u2', imageUrl: 'https://picsum.photos/id/1043/600/800', caption: 'Today was so beautiful', likes: 32, comments: [], timestamp: '1 hour ago', isLive: true },
